...
class Bootstrap extends \mata\base\Bootstrap {
	...
	private function addItemEnvironmentJoin($activeQuery, $documentId, $documentIdBase) {
        ...
        $hasEnvironmentRecords = \Yii::$app->cache->get(__CLASS__ . "_has_records_" . md5($documentIdBase));
        ...
        if ($hasEnvironmentRecords === false) {
            ...
            \Yii::$app->cache->set(__CLASS__ . "_has_records_" . md5($documentIdBase), $hasEnvironmentRecords);
        }
